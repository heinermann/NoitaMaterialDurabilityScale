-- Forked from https://github.com/DaftBrit/NoitaArchipelago/blob/master/settings.lua
...
local mod_id = "wiki_durability" -- This should match the name of your mod's folder.
mod_settings_version = 1 -- This is a magic global that can be used to migrate settings to new mod versions. call mod_settings_get_version() before mod_settings_update() to get the old value. 
local mod_settings = 
{
  {
    id = "wiki_iter",
    ui_name = "Iteration Number",
    ui_description = "Determines which spell to spawn on new game, increments each time. Start at 1.",
    value_default = "1",
    text_max_length = 6,
...
function ModSettingsUpdate( init_scope )
  ...
  print_error("MOD SETTINGS SET " .. tostring(init_scope))
end
